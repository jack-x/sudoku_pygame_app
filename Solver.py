...
def solveSudokuConcise(sudokuGridFunctionParam):
    '''
    returns double dimensional solved sudoku array
    Takes sudoku grid, a double dimensional list, as input and gives out the solved sudoku grid as return value.
